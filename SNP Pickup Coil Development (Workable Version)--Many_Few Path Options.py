...
filenameid = 'SNP Development 60 deg Tri extra YBCO top bottom' # name of .mn work file. The data files are named in a pattern as (.mn )-p(problem no.)_3DTable.txt.
loglocation = r'/Users/kean/Downloads' # file location
# loglocation = r'C:\Users\klx\OneDrive - Oak Ridge National Laboratory'

log_filepath = os.path.join(loglocation, f"{filenameid}_log.txt")  #have one created already on your device that follows the name of the log filepath

CRa = [.2] # current ratio (center coil /side coil)
...
with open(log_filepath, 'a') as logid: #need to have already created your own log file on your device
