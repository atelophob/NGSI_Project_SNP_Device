...
P0 = np.array([0.0, 1.0, 0.0])  # Initial polarization vector



# Read magnetic field distribution (B) from file

data = np.loadtxt(r"C:\Users\klx\OneDrive - Oak Ridge National Laboratory\SNP Device Nutator Work SC_Table [88.6, .2, 444] [Nut 420An, Sol 160An] [+X].txt")
...
plt.plot(z, P, label = ['Px', 'Py', 'Pz'])

plt.legend()

plt.title("Px, Py, Pz, vs Dist through the center")
